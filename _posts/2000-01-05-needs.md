...
## Spring Integration Test with a Need
...
and the following Spring Java Config and which uses In-Memory Derby Database:
...
By now you are already familiar with the basic of Spring integration testing
...
### Spring System Test with Docker Container Need
...
1. adds the `TestDatabaseConfig` the running application's spring application context
...
resource in your production environment and Testify will take care of managing
the lifecycle of these needs. 
