 ...
 * {@link Mock} that does some smart name/type based detection on the cut class
 * constructor.
 *
 * @author saden
 */
public class TypeMockInjector implements TestInjector {
    ...
    public TypeMockInjector(TestContext context,
    ...
    public void inject() {
        ...
        if (parameterDescriptors.containsKey(descriptorKey)) {
            ...
            Integer parameterIndex = descriptor.getIndex();
            arguments[parameterIndex] = testReifier.reifyField(fieldDescriptor, descriptor);
        } else {
            ...
            for (ParameterDescriptor descriptor : descriptors) {
                ...
                if (parameterType.equals(fieldType)) {
                    arguments[index] = testReifier.reifyField(fieldDescriptor, descriptor);
                    break;
                }
