 ...
 */
package com.fitbur.testify.examples.junit.spring.need.database;
...
/**
 * Hibernate SessionFactory Bean Factory.
 *
 * @author saden
 */
@Named
public class SessionFactoryFactoryBean implements FactoryBean<SessionFactory> {
    ...
    public SessionFactory getObject() throws Exception {
        ...
        Reflections reflections = new Reflections(GreetingConfig.class.getPackage().getName());
